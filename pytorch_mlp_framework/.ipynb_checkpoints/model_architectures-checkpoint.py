...
class ConvolutionalProcessingBlockWithBN(nn.Module):
    ...
    def build_module(self):
        ...
        self.layer_dict['bn_1'] = nn.BatchNorm2d(self.input_shape[1])
        out = self.layer_dict['conv_1'].forward(out)
        # insert Batch Normalization
...
class ConvolutionalProcessingBlockWithBNWithRC(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalProcessingBlockWithBNWithRC, self).__init__()
...
class ConvolutionalDimensionalityReductionBlockWithBNWithRC(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ConvolutionalDimensionalityReductionBlockWithBNWithRC, self).__init__()
